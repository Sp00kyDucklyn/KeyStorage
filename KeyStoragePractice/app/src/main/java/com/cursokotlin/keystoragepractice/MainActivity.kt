package com.cursokotlin.keystoragepractice
...
import com.cursokotlin.keystoragepractice.ui.theme.KeyStoragePracticeTheme
import java.io.File
                ...
                Column(
                    ...
                    Row{
                        Button(onClick = {
                            ...
                            messageToDecrypt= cryptoManager.encypt(
                                bytes = bytes,
                                outputStream = fos
                            ).decodeToString()
                        }){
